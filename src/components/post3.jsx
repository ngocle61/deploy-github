                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <p>
                                    Thế nhưng, đối với những người làm và hiểu biết thực sự về khoa học công nghệ
                                    thì nó là cột mốc và tiêu chuẩn quyết định cho một nền công nghiệp và sản xuất của một quốc gia.
                                    Có một luật bất thành văn rằng: Chỉ 1 quốc gia có khả năng sản xuất 100% nội địa hóa được 1 cái máy khâu (với giá thành hợp lý)
                                    thì khi ấy quốc gia đó mới đủ khả năng bước chân vào hàng ngũ những quốc gia có nền sản xuất công nghiệp phát triển.
                                    Bởi máy khâu là mặt hàng gia dụng thiết yếu mà mọi người dân đều sử dụng,
                                    ko những thế trong nó còn hàm chứa vô vàn những nền tảng căn bản của một nền sx công nghiệp cho tương lai
                                    (để chế tạo những thứ phức tạp hơn như ô tô hay xe máy).
                                </p>
                                <p>
                                    Để làm ra một cái máy khâu thì nền công nghiệp đó đòi hỏi phải có trình độ luyện kim - tức từ
                                    quặng thép khai thác ở dưới đất tạo ra phôi thép.
                                    Đây là giai đoạn cực kì quan trọng, bởi muốn có được một cái máy khâu chắc chắn, bền bỉ,
                                    các chi tiết bên trong máy chống chịu được sự mài mòn khi vận hành; thì các chi tiết máy bên
                                    trong ngay từ chi tiết rất nhỏ như cái mũi kim khâu cũng phải đạt được độ cứng sao cho hoạt động liên tục
                                    (dập như máy khâu) hàng triệu triệu lần mà ko hỏng hóc hay gẫy vỡ. Nên nhớ hiện tại Vn vẫn nhập khẩu từ mũi kim,
                                    sợi chỉ từ TQ chính vì chúng ta đã mất gốc ngay từ giai đoạn căn bản này rồi.
                                </p>
                                <p>
                                    Sau đó tiếp tục đòi hỏi công nghệ cơ khí chính xác để gia công những phôi thép nói trên tạo hình thành cái máy khâu
                                    hoàn chỉnh từ phần thân vỏ, tay quay, cho tới vô vàn những chi tiết nhỏ bên trong máy khâu.
                                    Chính vì phải gia công làm sao ra dc những chi tiết nhỏ, mà sai số so với bản vẽ thiết kế rất thấp
                                ...
                                <p>
                                    ...
                                    tô như dòng Zotye đang làm mưa, làm gió ở VN vì giá rẻ mà chất lượng hơn hẳn Hàn, Nhật (so với tầm giá).
                                </p>
                                <p>
                                    Còn khi anh cố tình làm ô tô mà trong tay ko có luyện kim, ko có cơ khí chính xác,
                                    ko có một nền công nghiệp nặng hùng mạnh đứng đằng sau để hỗ trợ; đến cây kim, cái máy khâu còn làm ko nổi ?
                                    Như thế chắc chắn toàn bộ linh kiện của 1 cái ô tô "thương hiệu Việt" sẽ phải đi nhập từ nước ngoài; mà nhập toàn
                                    bộ ko nội địa hóa được thì lấy đâu ra giá rẻ để người tiêu dùng ủng hộ ? Mà anh ko có khả năng
                                    tự làm dc cái gì, ko nắm dc công nghệ gì.
                                    Vậy làm sao có đủ kiến thức, trình độ kinh nghiệm để bảo dưỡng, sữa chữa một cái ô tô tiền tỉ trong suốt quá trình vận hành ?
                                </p>
                                <p>
